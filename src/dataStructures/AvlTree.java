...
public class AvlTree<E extends Person> implements Serializable {	
    ...
    public AvlTree(String id, Comparator<E> comparator, int maxCoincidences) {
        this.id = id;
	...
	public void add(E e) {
        ...
        switch(getId()) {
        case "1":
        	e.setTree1((Node<Person>) node);
        	break;
        case "2":
        	e.setTree2((Node<Person>) node);
        	break;
        case "3":
        	e.setTree3((Node<Person>) node);
        	break;
        case "4":
        	e.setTree4((Node<Person>) node);
        	break;
        }
