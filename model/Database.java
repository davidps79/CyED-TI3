...
public class Database {
    ...
    public ArrayList<Person> getCoincidences(String filter, String toSearch) {
    	...
    	switch(filter) {
    	case "Nombre":
        	arr = peopleByName.searchCoincidenceByName(toSearch);
    	case "Apellido":
    		//arr = peopleByLastName.searchCoincidenceByLastname(toSearch);
    		break;
    	case "Nombre completo":
    		//arr = peopleByFullname.searchCoincidenceByFullname(toSearch);
    		break;
    	case "C�digo":
    		//arr = peopleById.searchCoincidenceById(toSearch);
    		break;
